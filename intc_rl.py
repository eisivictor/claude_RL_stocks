...
# Get INTC data
print("Fetching INTC historical data...")
data = get_historical_data('INTC', period=1)
...
agent.load('intc_trading_model.weights.h5')
...
testing_agent('intc', agent, data, LOOKBACK_WINDOW_SIZE, INITIAL_CAPITAL)

# Save the trained model
print("saving the model weights...")
agent.save('intc_trading_model.weights.h5')
